...
class GQBaselineDataset(Dataset):

    def __init__(self, question_data, answer_data, title_data, use_embeddings, dist_features, idxs, targets=None):
    ...
    def __getitem__(self, idx):
        ...
        return question, answer, title, use_emb_q, use_emb_a, use_emb_t, dist_feature, target

    def __len__(self):
        return len(self.question_data)


class GQBaselineDataset_old(Dataset):

    def __init__(self, question_data, answer_data, title_data, category_data, host_data,
                 use_embeddings, dist_features, idxs, targets=None):
        self.question_data = question_data[idxs]
        self.answer_data = answer_data[idxs]
        self.title_data = title_data[idxs]
